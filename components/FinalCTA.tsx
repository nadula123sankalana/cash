    ...
    <section className="py-24 gradient-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-heading font-bold text-white mb-8 text-shadow leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <button className="group relative bg-accent-cyan text-gray-900 font-bold text-lg md:text-xl px-10 md:px-14 py-5 md:py-6 rounded-xl button-hover shadow-2xl w-full sm:w-auto overflow-hidden">
